...
% dimension. "input" may either be the dimension desired (if a scalar), or
% a matrix of directions that should be directions in the resulting matrix
% (they will be forced orthogonal if not, in order across columns).
