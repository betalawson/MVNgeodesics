...
%
% This internal function creates a new set of axes for plotting - axes 
% created are equal in size and positioned according to the sizing
% properties provided. Properties that aren't provided are assigned default
% values, which may be changed here

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
default.margin = 0.025;
default.xgap = 0.025;
default.ygap = 0.025;
default.leftspace = 0;
default.topspace = 0;
default.rightspace = 0;
default.bottomspace = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
